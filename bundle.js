...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _jquery311Min = __webpack_require__(1);
	...
	var totalLikers = [];
	var totalAds = []; // Currently 21
	var numVerticals = void 0; //Currently 14
	var verticalsExtracted = 0;
	var adsExtracted = 0;
	var likersExtracted = 0;
	...
	function receiveAds(ads) {
	  ...
	  if (numVerticals == verticalsExtracted) {
	    totalAds = totalAds.filter(function (ad, index, self) {
	      return self.findIndex(function (a) {
	        return a.adURL === ad.adURL && a.verticalTitle === ad.verticalTitle;
	      }) === index;
	    });
